...
from start_ui import get_modified_tts_and_play
        ...
        if flag_KWS:
            ...
            if sv_result == "yes":
                if stt_message and stt_message.strip():
                    ...
                    modified_tts_and_play = get_modified_tts_and_play()
                    modified_tts_and_play(text, used_speaker, os.path.join(folder_path,f'{folder_path}/sft_{audio_file_count}.mp3'))
                else:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Emotic LLM Agent')
    parser.add_argument('--url', type=str, default='https://40094c75d1b7.ngrok-free.app', help='情感流URL')
