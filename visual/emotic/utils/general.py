...
from visual.emotic.utils.google_utils import gsutil_getsize
from visual.emotic.utils.metrics import fitness
from visual.emotic.utils.torch_utils import init_torch_seeds
...
def check_img_size(img_size, s=32):
    ...
    if new_size != img_size:
        print('[visual]WARNING: --img-size %g must be multiple of max stride %g, updating to %g' % (img_size, s, new_size))
    return new_size
